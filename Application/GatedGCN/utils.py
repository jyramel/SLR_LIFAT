...
def train_val_pipeline(train_loader, test_loader, val_loader, params, net_params):
    ...
    from GatedGCN.train import train_epoch_sparse as train_epoch, evaluate_network_sparse as evaluate_network
...
def init_params(trainset, nb_classes, epoch = 1000):
    ...
    jsonPath = "GatedGCN/graph_classification_GatedGCN.json"
    ...
    net_params["device"] = torch.device("cuda" if torch.cuda.is_available() else "cpu")
